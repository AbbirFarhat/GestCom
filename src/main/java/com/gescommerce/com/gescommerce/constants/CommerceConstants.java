package com.gescommerce.com.gescommerce.constants;
...
public class CommerceConstants {
    ...
    public static final String PRODUCT_ADDED = "Article has been added successfully!";
    public static final String INVALID_PRODUCT = "Article id does not exist.";
    public static final String PRODUCT_UPDATED = "Article has been updated successfully!";
    public static final String PRODUCT_DELETED = "Article has been deleted.";
    public static final String PRODUCT_STATUS_UPDATED = "Article status has been updated successfully!";
    public static final String MISSING_REQUIRED_DATA = "Cannot generate file. Missing required data.";
    public static final String CLIENT_ADDED = "Client has been added successfully!";
